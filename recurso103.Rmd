...
barplot(counts, main="Numero de cambios adelante por Tipo de motor",  xlab="Numero de cambios adelante ",col=c("#195e4b","#00da9d"),
...
```{r, fig.height=5}
h1=hist(nf, main = "Nota final matemáticas fundamentales", xlab = "nota", ylab="frecuencias absolutas", labels=TRUE, col=c1, ylim = c(0,30))
abline(v=3,col="#2956b2")
```
...
```{r, fig.height=5}
plot(AirPassengers, main="Numero de pasajeros por mes", col="dodgerblue3", lwd = 3)
```
...
ggplot(data, aes(x=carrera, y=frecuencia)) +
  geom_bar(stat="identity", fill="#0d3b66")+
