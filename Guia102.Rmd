...
|:--------------|:-----------------------------  |
|Trabajo individual| **Actividad 121** - **Caso 1** :  Realice las actividades consignadas en el caso101, adjunte y envíe las respuesta a la plataforma de Brightspace en formato pdf |
...
|:--------------|:-----------------------------  |
|Trabajo individual|**Actividad 122** :  A partir de la información contenida en la **base de datos seleccionada en la Actividad 102**, realice un análisis de al menos dos variables cualitativas y dos cuantitativas teniendo como soportes las tablas de frecuencia y los indicadores estadísticos correspondiente.|
|Recursos| Base de datos actividad-1 Unidad 1.1|
|               |Excel                |
|               |RStudio              |
||Código u1.2                         |
|Fecha          | 07 de agosto 2022  |
...
|:--------------|:-------------------------------|
|**Actividad104.pdf**|  Desarrollo del Caso 1  |
|**Actividad105.pdf**|  Aplicar lo aprendido en la unidad 1.2 a la base de datos seleccionada para la actividad102    |
|Fecha          |Domingo 07 de agosto de 2022    | 
