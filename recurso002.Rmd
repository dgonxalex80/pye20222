---
title: <span style="color:#b0394a"> **Recursos  0.2**</span>  
author: "dgonzalez "
subtitle: <span style="color:#b0394a">**Módulo 0- Unidad 0.2**</span> 
output:
  html_document:
    toc: yes
    toc_depth: 2
...
Inicialmente se presenta su definición
...
+ **por compresión** : $A=\{ x \in \mathbb{Z}|  0 \leq x  \leq 9    \}$, utilizando  nomenclatura matemática.
...
Unión del $A$ con el conjunto $B$.

$A \cup B$, $\overline{A}$ ,$A - B$, entre  otras. La zona sombreada en la siguiente figura representa estas operación
...
$A = \{a,e,i,o,u \}$ y $B = \{1,2,3,4,5,6,7,8,9,0\}$
Entonces : 
