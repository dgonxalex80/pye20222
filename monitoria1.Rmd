...
|   |                                                  |
|:--|:-------------------------------------------------|
|a. | Divide la muestra en dos partes de igual de proporción de datos. |
...
|c. | Dos conjuntos de datos de tamaños $n_1$ y $n_2$ tienen respectivamente promedios $\bar{x}_{2}$ y $\bar{x}_{2}$. |
|d. | A partir de esta información, se puede obtener el respectivo estadístico del total de datos  |
...
|k. | Las gráficas se representan en el primer cuadrante. |
...
Mayo: 14.3, 14.4, 11.1, 11.2, 11.4, 11.4, 11.4, 11.4, 10.0, 10.5, 
      10.5, 10.6, 10.7, 12.1, 12.3, 12.4, 12.8,  9.3,  9.2,  9.2, 
       9.1,  8.4,  8.5,  7.2,  7.1,  6.2, 13.7, 13.8, 15.0  10.0

Junio: 12.0, 12.0, 12.0, 12.7, 12.8, 12.9,  8.0,  8.0, 13.2, 13.3, 
       13.5, 13.6, 11.0, 11.5, 11.6, 11.9, 10.4, 10.3, 10.7,  9.0, 
        9.2,  7.4,  7.7,  6.1,  5.9, 14.3, 14.2, 14.8, 15.1, 15.2
```
...
|b. | Las ventas de 6.2 millones representan un dato atípico   | 
...
|h. | En la variable nivel tecnológico, el promedio es: $\dfrac{12.5+40+42.5}{3}$ |
...
|l. | 40 empresas tienen un nivel tecnológico medio |
