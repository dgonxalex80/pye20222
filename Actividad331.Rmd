...
| 12 |Valencia Piedrahita Maria	        | 24	|Ruiz Calero Santiago	      |	36  |Escobar William                  |
...
**Nota**: Como ejemplo da la asignación de los modelos, el id=1 corresponde al primer estudiante de la Tabla 2 le corresponde el modelo 9 de la Tabla 1 : a Ramirez Emerson le corresponde realizar un artículo sobre el modelo gamma
