...
+ Graficar la función de probabilidad y la distribución de probabilidad de $X$. 
+ ¿Cuál es la probabilidad de encontrar menos de $3$ imperfecciones en $10$ metros de una tela seleccionada al azar?.
+ Calcule el valor esperado del número de imperfecciones obtenidas por 10 metros de tela 
+ Calcule la varianza del número de imperfecciones obtenidas por 10 metros de tela
...
La función de probabilidad del número de personas que llegan al restaurante solo esta definida para valores de $x = 0, 1, . . . , 25$ y es de la forma:
...
https://github.com/dgonxalex80/pye20222/blob/main/Taller311Rmd.Rmd