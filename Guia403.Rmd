...
|:-----------------|:-----------------------------  |
|**Actividad 431** | Resuelva las preguntas y problemas planteadas en el [**Taller 431**](https://github.com/dgonzalez80/probabilidad20212.io/blob/main/talleres/Taller431.pdf ) y entregue su solución  en formato  pdf en el enlace correspondiente de  Brightspace   |
|Trabajo individual|                                |
...
|               |                              | 
|:--------------|:-----------------------------|
| Actividad 431 | Mapa mental sobre pruebas de hipótesis|
| Actividad 432 | Solucionario taller 431 de problemas sobre pruebas de hipótesis| 
