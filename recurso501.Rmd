...
$$\widehat{y_{i}} = 1.77788 + 0.55817 x_{i}$$
...
```{r, echo=FALSE, out.width="20%", fig.align = "lef"}
...
library(remotes) 
library(devtools)  
install_github("dgonzalez80/paqueteDEG", force = TRUE) # bajar paquete
learnr::run_tutorial("Taller_regresion1", "paqueteDEG") # correr instructivo 1
...
library(remotes) 
library(devtools)  
install_github("dgonzalez80/paquetDEG", force = TRUE) # bajar paquete
learnr::run_tutorial("Taller_regresion2", "paqueteDEG") # correr instructivo 2 (se corre uno de los dos !!)
```
