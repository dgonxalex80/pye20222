...
La presente  unidad será desarrollada durante la comprendida entre 26 de septiembre al 2 de octubre     
...
|:----------------|:------------------------------------------------------------------------|
|**Actividad 331**|**blog** : Construir un blog  enformato Rmd (Rmarkdown)  para cada uno de los modelos asignados que contenga sus principales características |
|                 | Trabajo en equipo de  2 estudiantes                                    |
|Fecha            | 2  de octubre                                                          |
|Hora             | 23:59                                                                  |
...
|                |                                                                         | 
|:---------------|:------------------------------------------------------------------------|
|**Activiad 332**| De manera individual deberá resolver el problema asignado del [**taller de simulación**](https://dgonxalex80.github.io/probabilidad20212.io/Actividad332.html))  para ser resuelto con ayuda computacional. El resultado se debe publicar en RPub y si enlace copiado en el enlace de la actividad en Bs                                         |
|               | Trabajo individual                                                      |
|Fecha          | 2 de octubre                                                            |
|Hora           | 23:59                                                                   |
...
|Actividad      | Descripción                      | 
|:--------------|:---------------------------------|
|Entregable 1   | carpeta con archivos Rmd, html  e imagenes  en un solo archivo zip (se debe utilizar el paquete distill de R para generar la plantilla) |
|Entregable 2   |  enlace de Rmd publicado con el desarrollo del prolema asignado |
