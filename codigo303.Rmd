---
title: <span style="color:#8acfe6"> **Código 3.3**</span> 
author: "dgonzalez "
...
|    |                                     |
|:--:|:------------------------------------|
| ![](img/ej1.png)|  Sea una variables con distribución binomial con parámetros $n=20$ y $p=0.30$ , lo cual se puede simbolizar como : $X\sim b(x; 20,0.30)$|
...
|    |                                     |
|:--:|:------------------------------------|
| ![](img/ej2.png)|  Ahora supongamos que se tiene una variable continua con distribución normal, con media 50 y varianza 100, es decir desviación estándar 10, lo cual se puede representar como $X\sim N(50,100)$.  |
...
|    |                                     |
|:--:|:------------------------------------|
| ![](img/ej3.png) | Se fabrican placas rectangulares cuyas longitudes en pulgadas se distribuyen como $N(2.0; 0.01)$ y cuyos anchos se distribuyen $N(3.0; 0.04)$. Suponga que las longitudes y los anchos son independientes. El área de una placa esta dada por $A=XY$. |
